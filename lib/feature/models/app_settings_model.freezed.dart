...
abstract class $AppSettingsModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({@HiveField(0) String themeMode});
}
...
class _$_AppSettingsModel
  ...
  const _$_AppSettingsModel({@HiveField(0) required this.themeMode});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'AppSettingsModel(themeMode: $themeMode)';
  }
...
abstract class _AppSettingsModel implements AppSettingsModel {
  const factory _AppSettingsModel(
      {@HiveField(0) required final String themeMode}) = _$_AppSettingsModel;
